...
<table border="1">
    <tr>
        <td colspan="5">
            <h1>spring springJDBC springMVC ajax实现对数据的增删改查</h1>
        </td>
    </tr>
    <tr>
        <td width="50">Id</td>
    ...
    <tr>
        <td colspan="5">共&nbsp;${pageBean.getTotalPages()}&nbsp;页&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <a href="list?pageNo=${pageBean.getTopPageNo()}">首页</a>
            <a href="list?pageNo=${pageBean.getPreviousPageNo()}">上一页</a>
            <a href="list?pageNo=${pageBean.getNextPageNo()}">下一页</a>
            <a href="list?pageNo=${pageBean.bottomPageNo}">尾页</a>
            <a href="add">添加</a>
        </td>
    </tr>
</table>
